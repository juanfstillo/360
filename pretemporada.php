...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- SEO -->
    <meta name="Description" content="Academia de tenis. Pretemporada de tenis para todo tipo de jugadores. Mejora tus condiciones tecnicas, tacticas y fisicas">
  </head>
  <body>
  ...
  <div class="card mb-3">
  <div class="card-body">
    <h4 class="dark-color">Pretemporada</h4>
    <p class="card-text">Las pretemporadas se realizan durante los primeros meses del año. A lo largo de este período trabajaremos de manera intensiva y en equipo para mejorar cada vez más tus condiciones. Desde el inicio, el Programa de Entrenamiento estará diseñado a medida de los participantes. Vení y ponete en forma en nuestro Centro de Entrenamientos.
</p>
<img src="images/preparate.jpg" class="card-img-top" alt="clasesParticulares">
