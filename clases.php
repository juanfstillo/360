...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- SEO -->
    <meta name="Description" content="Academia de tenis. Clases de tenis particulares para todo tipo de jugadores. Mejora tus condiciones tecnicas, tacticas y fisicas rapidamente">
  </head>
  <body>
  ...
  <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="images/clasesIn.png" alt="clasesIn" /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder">Clases</h1>
                        <div class="fs-5 mb-5">
                        </div>
                        <p class="lead">
                        En nuestra propuesta, te traemos una variedad de clases de tenis adaptadas para todos los gustos y niveles. Nuestros instructores altamente capacitados te van a guiar en cada paso para que puedas mejorar tus habilidades y disfrutar del tenis al mango.
                        Nuestras clases son para todos, desde los pibes que recién empiezan hasta los que ya le meten con ganas. Tanto para los jóvenes que están a full como para los adultos que quieren meterle garra al tenis, tenemos programas a medida. Te aseguramos que con nuestra onda dinámica vas a pegarle un salto en tu juego, sin importar si sos joven, veterano o estás en el medio.
                        Sumate a nuestro equipo y descubrí cómo podés perfeccionar tus habilidades, agarrar más confianza en la cancha y, lo más importante, disfrutar al mango de tu pasión por el tenis. ¡Te esperamos para hacer tenis juntos.                        
                      </p>
                    </div>
                </div>
            </div>
