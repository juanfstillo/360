...
<meta name="theme-color" content="#ffffff">
  ...
  <div class="card mb-3">
  <div class="card-body">
    <h4 class="dark-color">Clases Particulares</h4>
    <p class="card-text">El tenis es un deporte que requiere de mucha coordinación, concentración y paciencia. 
Se trabaja mucho la parte mental y física en detalle por ello es una de las mejores opciones para mejorar rápidamente. Físicamente favorece la movilidad y la flexibilidad además de fortalecer la musculatura y los huesos.

En este tipo de clases podemos observar detalladamente la coordinación, los gestos técnicos y progreso personal. 
</p>
<img src="images/mejora.jpg" class="card-img-top" alt="clasesParticulares">
