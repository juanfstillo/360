      ...
      <div class="container">
        ...
        <div class="row" style="place-content: center;" >
          ...
          <h1 class="dark-color">Contacto</h1>
              ...
              <li>Club Nuevo Tiro Federal - Tambor de Tacuari 501 <br>Caba-Argentina</li></a>
        </div>
        <div class="row" style="place-content: center;" >
          <ul class="list-unstyled mb-0" style="text-align-last: center;padding-bottom: 10px;padding-top: 10px;">
              <li><a href="https://wa.me/+5491121878742"><img src="images/whatsapp-solid.svg" style="width:50px" align="middle" alt="Phone"></li>
