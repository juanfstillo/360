...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- SEO -->
    <meta name="Description" content="Academia de tenis. Preparacion fisica para jugadores de todos los niveles">
  </head>
  <body>
  ...
  <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="images/gestionIn.png" alt="gestionIn" /></div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder">Gestión de Clubes</h1>
                        <div class="fs-5 mb-5">
                        </div>
                        <p class="lead">
                        Nos dedicamos a la gestión integral de clubes de tenis. Ofrecemos un combo completo de servicios para que tu club funcione a la perfección y tus socios estén contentos. Somos fanáticos de simplificar la vida de los clubes, te lo hacemos fácil.

Desde manejar la taquilla hasta organizar torneos, lo tenemos cubierto. No importa si sos un club chico o grande, tenemos lo que necesitás para que todo funcione de 10. Con nuestra onda, tu club va a andar de 11.

Vení a charlar con nosotros y descubrí cómo podemos hacer que la gestión de tu club sea un golazo. ¡Hacemos que todo esté en orden mientras vos te dedicás a disfrutar del tenis!
                      </p>
                    </div>
                </div>
            </div>
