...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- SEO -->
    <meta name="Description" content="Torneos de tenis para todos los niveles. Ranking UTR">
  </head>
  <body>
  <?php require "components/navbar.php"; ?>

  <div class="card mb-3">
  <img src="images/todos.jpeg" class="card-img-top" alt="nosotros">
  <div class="card-body">
    <h4 class="dark-color">Nosotros</h4>
    <p class="card-text">Nuestro objetivo principal es hacer nuestro pequeño aporte para mejorar la condición técnica y táctica de los jugadores de tenis. A través de profesionales especializados en la materia, ofrecemos todos los instrumentos y conocimientos necesarios para lograr una buena formación integral.

    Proponemos nuestro servicio como una posibilidad para aquellos que quieran lograr un buen rendimiento, brindándoles así todos los materiales posibles para lograr cumplir los objetivos buscados.</p>
  </div>
</div>
