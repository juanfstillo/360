...
<meta name="theme-color" content="#ffffff">
  ...
  <div class="card mb-3">
  <div class="card-body">
    <h4 class="dark-color">Preparación Física</h4>
    <p class="card-text">Le brindamos a los jugadores y alumnos una preparación física para complementar con sus clases de tenis. 
Buscamos poner en el mejor estado posible de forma al deportista mediante sus aptitudes naturales y desarrollando al máximo sus cualidades físicas.
Nuestro equipo profesional realiza ejercicios explosivos, de coordinación y resistencia.
Le damos un enfoque de preparación física de tenis para después realizarlo en la cancha.

</p>
<img src="images/ent.jpg" class="card-img-top" alt="clasesParticulares">
