	  ...
	  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		<div class="panel panel-default">
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading0">
			<h3 class="panel-title">
			  ...
			  ¿Hay que ser socio para venir al club?</a>
			</h3>
		  </div>
		  <div id="collapse0" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
			<div class="panel-body px-3 mb-4">
			  <p>No hay que ser socio para venir, la entrada es libre.</p>
			</div>
		  </div>
		</div>
		...
		<div class="panel panel-default">
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading1">
			<h3 class="panel-title">
			  ...
			  ¿Sino tengo raqueta, ustedes me prestan?</a>
			</h3>
		  </div>
		  <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
			<div class="panel-body px-3 mb-4">
			  <p>Si, nosotros te prestamos raqueta en caso de que no tengas.</p>
			</div>
		  </div>
		</div>
    	...
    	<div class="panel panel-default">
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading7">
			...
			¿Qué sucede si llueve en el horario donde tengo mi clase?</a>
			</h3>
		  </div>
		  <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading7">
			<div class="panel-body px-3 mb-4">
			  <p>Las clases se suspenden en caso de lluvia, recuperándose en fecha posterior a acordar con nosotros. La suspensión será anunciada por un miembro de nuestro staff. Bajo ningún aspecto se cancelarán clases por condiciones climáticas diferentes a la lluvia ( leáse viento o bajas temperaturas)</p>
			</div>
		  </div>
		</div>
		...
		<div class="panel panel-default">
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading2">
			<h3 class="panel-title">
			  <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="true" aria-controls="collapse3">
			¿Qué sucede si no puedo asistir a mi clase?</a>
			</h3>
		  </div>
		  <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
			<div class="panel-body px-3 mb-4">
			  <p>De no poder asistir a tu clase debes comunicarte con nosotros al menos 24 horas antes para poder reprogramar para otra fecha. Caso contrario, la clase se perderá. </p>
			</div>
		  </div>
		</div>
		  ...
		  <div class="panel-heading p-3 mb-3" role="tab" id="heading4">
			<h3 class="panel-title">
			  <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="true" aria-controls="collapse4">
        		¿Qué calzado debo llevar a la clase?
			  </a>
			</h3>
		  </div>
		  <div id="collapse4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4">
			<div class="panel-body px-3 mb-4">
			  <p>Es importante asistir con el calzado recomendado para la práctica del tenis. Te dejamos una imágen de la suela correspondiente.</p>
			  <img src="images/suela.png" alt="suelaTenis">
			</div>
		  </div>
		</div>
		...
		<div class="panel panel-default">
		  ...
		  <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5">
			<div class="panel-body px-3 mb-4">
			  <p>Si, el club cuenta con estacionamiento propio. Se ingresa al mismo por el mismo lugar que ingresas al club.</p>
			</div>
		  </div>
		</div>
