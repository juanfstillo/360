...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- SEO -->
    <meta name="Description" content="Academia de tenis. Clases de tenis grupales para todo tipo de jugadores. Mejora tus condiciones tecnicas, tacticas y fisicas rapidamente">
  </head>
  <body>
  ...
  <div class="card mb-3">
  <div class="card-body">
    <h4 class="dark-color">Clases Grupales</h4>
    <p class="card-text">Nuestro equipo tiene la experiencia y capacidad profesional para desarrollar clases grupales de distintas edades y niveles. 
Tratamos de brindarles a los alumnos una clase dinámica, divertida y efectiva. 
El aprendizaje es mucho más didáctico, ya que el alumno tiene la posibilidad de socializar con otras personas dentro de ese espacio mientras realiza la actividad.</p>
<img src="images/competi.png" class="card-img-top" alt="clasesParticulares">
