...
<meta name="theme-color" content="#ffffff">
  ...
  <div class="card mb-3">
  <div class="card-body">
    <h4 class="dark-color">Entrenamiento</h4>
    <p class="card-text">Los entrenamientos que realizamos son de alto rendimiento. Los ejercicios llevan al jugador a superar su coordinación, capacidad física y técnica. 
Nuestro objetivo es que el alumno cumpla con sus expectativas durante el periodo de entrenamiento ayudándolo a mejorar y superar sus capacidades. 
Hacemos un seguimiento personal de su rendimiento en la cancha. 
Les proponemos a los jugadores que se anoten en torneos o encuentros para observarlos.
También realizamos entrenamientos a grupos de competencia de muchas ligas e Interclubes.
</p>
<img src="images/ejercitate.jpg" class="card-img-top" alt="clasesParticulares">
